  ...
  return (
    <div className="px-6 py-12">
      ...
      <section className="flex flex-col md:flex-row-reverse items-center justify-between mb-12">
        ...
        <div className="w-full md:w-1/2 px-6">
          <h3 className="text-2xl font-bold text-teal-600">Our Story</h3>
          <p className="text-gray-600 mt-4">
      ...
      <section className="text-center mb-12">
        ...
        <div className="flex flex-wrap justify-center mt-6">
          <div className="p-6 m-4 border rounded-lg w-60">
            <h4 className="text-xl font-semibold">12 Global Offices</h4>
            <p className="text-gray-600 mt-2">Learn more</p>
          </div>
          <div className="p-6 m-4 border rounded-lg w-60">
            <h4 className="text-xl font-semibold">7,600+ Employees</h4>
            <p className="text-gray-600 mt-2">Learn more</p>
          </div>
          <div className="p-6 m-4 border rounded-lg w-60">
            <h4 className="text-xl font-semibold">205,000+ Customers</h4>
            <p className="text-gray-600 mt-2">Learn more</p>
          </div>
        </div>
      </section>
